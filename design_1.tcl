...
xilinx.com:ip:rs_decoder:9.0\
xilinx.com:ip:rs_encoder:9.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: rs_decoder_0, and set properties
  set rs_decoder_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:rs_decoder:9.0 rs_decoder_0 ]
  set_property -dict [ list \
   CONFIG.Error_Statistics {true} \
   CONFIG.Field_Polynomial {391} \
   CONFIG.Generator_Start {1} \
   CONFIG.Memory_Style {Block} \
   CONFIG.aresetn {true} \
 ] $rs_decoder_0

  # Create instance: rs_encoder_0, and set properties
  set rs_encoder_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:rs_encoder:9.0 rs_encoder_0 ]
  set_property -dict [ list \
   CONFIG.Data_Symbols {239} \
   CONFIG.Field_Polynomial {0} \
   CONFIG.Generator_Start {1} \
   CONFIG.Symbol_Per_Block {255} \
   CONFIG.Symbol_Width {8} \
   CONFIG.aclken {false} \
   CONFIG.aresetn {true} \
 ] $rs_encoder_0
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins rs_encoder_0/S_AXIS_INPUT]
  ...
  connect_bd_intf_net -intf_net axi_dma_1_M_AXIS_MM2S [get_bd_intf_pins axi_dma_1/M_AXIS_MM2S] [get_bd_intf_pins rs_decoder_0/S_AXIS_INPUT]
  ...
  connect_bd_intf_net -intf_net axi_dma_1_M_AXI_SG [get_bd_intf_pins axi_dma_1/M_AXI_SG] [get_bd_intf_pins smartconnect_1/S02_AXI]
  ...
  connect_bd_intf_net -intf_net rs_decoder_0_M_AXIS_OUTPUT [get_bd_intf_pins axi_dma_1/S_AXIS_S2MM] [get_bd_intf_pins rs_decoder_0/M_AXIS_OUTPUT]
  connect_bd_intf_net -intf_net rs_encoder_0_M_AXIS_OUTPUT [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins rs_encoder_0/M_AXIS_OUTPUT]
  ...
  connect_bd_net -net Net [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_dma_1/m_axi_mm2s_aclk] [get_bd_pins axi_dma_1/m_axi_s2mm_aclk] [get_bd_pins axi_dma_1/m_axi_sg_aclk] [get_bd_pins axi_dma_1/s_axi_lite_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP1_ACLK] [get_bd_pins rs_decoder_0/aclk] [get_bd_pins rs_encoder_0/aclk] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins smartconnect_1/aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_dma_1/axi_resetn] [get_bd_pins rs_decoder_0/aresetn] [get_bd_pins rs_encoder_0/aresetn] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins smartconnect_1/aresetn]
  ...
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces axi_dma_1/Data_SG] [get_bd_addr_segs processing_system7_0/S_AXI_HP1/HP1_DDR_LOWOCM] -force
